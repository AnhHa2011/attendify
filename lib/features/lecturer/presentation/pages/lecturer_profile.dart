...
class LecturerProfilePage extends StatefulWidget {
  ...
  @override
  State<LecturerProfilePage> createState() => _LecturerProfileState();
}

class _LecturerProfileState extends State<LecturerProfilePage>
    ...
    return _buildGlassCard(
      ...
      children: [
        ...
        _buildInfoTile(
          ...
          title: 'Phiên bản v1.0.0 (mới nhất)',
          subtitle: '',
