...
import '../../data/datasources/leave_request_remote_datasource.dart';
...
class _LecturerLeaveApprovalPageState extends State<LecturerLeaveApprovalPage> {
  ...
  String? _classId, _className; // lớp được chọn
  ...
  Stream<List<LeaveRequestModel>> _pendingRequests() {
    if (_classId == null) return const Stream.empty();
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (c, s) {
                ...
                final valid = docs.any((d) => d.id == _classId)
                    ? _classId
                    : null;
            ...
            if (_classId != null)
              StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                stream: _sessionsByClass(_classId!),
                builder: (c, s) {
                  if (s.hasError) {
                    return Text(
