...
class QRGeneratorService {
  ...
  static String generateAttendanceQRData({
    ...
    final qrData = {
      ...
      'signature': _generateSignature(classCode, sessionId, timestamp),
    };
  ...
  static String generateJoinClassQRData({
    ...
    final qrData = {
      ...
      'signature': _generateSignature(classCode, courseCode, validUntil),
    };
  ...
  static bool isQRCodeValid({required int timestamp, int validityMinutes = 5}) {
